...
insert into employee values(Null,'himani','gg','hh','h@g',9999);
insert into employee values(Null,'himani1','ggd','hh','h@g',89999);
...
INSERT INTO userdetails VALUES(NULL,'himani','himani123', CURDATE())
